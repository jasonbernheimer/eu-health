...
```{r}
# Opens web browser. not very helpful.
...
df %>%
  filter(COU %in% c("AUS", "CAN", "ISR", "JPN", "KOR", "MEX", "NZL", "USA", "BRA", "CHL", "CHN", "IND", "IDN", "RUS", "ZAF", ))

df2 <- df %>%
  filter(COU != "AUS" & COU != "CAN" &COU != "ISR" &COU != "JPN" &COU != "KOR" &COU != "MEX" &COU != "NZL" &COU != "USA" &COU != "BRA" &COU != "CHL" &COU != "CHN" &COU != "IND" &COU != "IDN" &COU != "RUS" &COU != "ZAF" &COU != "COL" &COU != "CRI")

countries <- unique(df2$COU)
